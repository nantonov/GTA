...
export const createCityService = async(city : ICreateUpdateCityModel) : Promise<Array<ICityGetModel>> => {
...
export const updateCityService = async(id: number, city: ICreateUpdateCityModel) : Promise<Array<ICityGetModel>> => {
